 ...
 *  MENÚ:   1:suma  2:resta  3:multiplicación  4:división         
 */
...
int main (int argc, char* argv[]){
  ...
  ofstream fichero (kFileName); 
   ...
   cout << "Introduzca 1 para obtener la suma, 2 para la resta, 3 para la multiplicación y 4 para la división."<< endl;
   int n;
   cin >> n;
